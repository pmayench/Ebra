...
namespace TestProject
{
    ...
    public class PatternChainOfResponibilityTest
    {
        ...
        {
            var contexto = new SyncroContexto(new MockOfferService(), new MockArticleService(), new MockOrderService(), new MockRepositoryVersion(), new MockArticleRepository() , new Repository < Article > ());
    ...
    public class SyncArticlesTest
    {
        ...
        public void SameArticleVersion()
        {
            ...
            var context = new SyncroContexto(new MockOfferService(), new MockArticleService(), new MockOrderService(), new MockRepositoryVersion(), new MockArticleRepository(), new Repository<Article>());
            //var context = new SyncroContext(new MockOfferService(), mockArticleService.Object, new MockOrderService(), mockRepositoryVersion,new Repository<Article>());// new MockArticleRepository());
